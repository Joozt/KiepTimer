...
class LowLevelKeyboardHook : IDisposable
{
    ...
    private static IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
    {
        if (nCode >= 0 && wParam == (IntPtr)WM_KEYDOWN)
        {
            ...
            // Cache, because the list of blocked keys could be changed during the KeyboardHookEvent
            bool isBlockedKey = LowLevelKeyboardHook.Instance.blockedKeys != null && LowLevelKeyboardHook.Instance.blockedKeys.Contains(vkCode);
